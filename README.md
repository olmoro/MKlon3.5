...
#### <p align="right">2023.05.09 — добавлено описание конструкции
...
Почему ESP32_Devkitc_V4, ведь на ней установлены только элементы питания и интерфейса? Вот и хорошо, в соответствии с аппетитом установим ESP32-WROOM-32D с 8 или 16 МБ вместо обычных 4 МБ. Припаять, поверьте, гораздо проще, чем выпаять для замены. И штыри паять только после распайки TSP32.  
